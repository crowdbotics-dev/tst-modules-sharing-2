...
## Project Structure
    ...
    ├── tst_modules_sharing_2  # Django project configurations
...
1. Clone this repo and `cd tst_modules_sharing_2`
...
2. Clone this repo and `cd tst_modules_sharing_2`
