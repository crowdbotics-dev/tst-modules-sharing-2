"""
Django settings for tst_modules_sharing_2 project.
...
ROOT_URLCONF = 'tst_modules_sharing_2.urls'
...
WSGI_APPLICATION = 'tst_modules_sharing_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_modules_sharing_2 API",
    "DESCRIPTION": "API documentation for tst_modules_sharing_2 App",
    "VERSION": "v1",
}
